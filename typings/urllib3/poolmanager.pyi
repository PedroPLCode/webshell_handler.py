...
class ProxyManager(PoolManager):
    ...
    """
    def __init__(self, proxy_url, num_pools=..., headers=..., proxy_headers=..., proxy_ssl_context=..., use_forwarding_for_https=..., **connection_pool_kw) -> None:
        ...
...
def proxy_from_url(url, **kw): # -> ProxyManager:
    ...
